// Mini Program has no browser atob; keep the Core decoder scoped to this module.
var atob = typeof wx !== "undefined" && wx.base64ToArrayBuffer ? function (value) {
  var bytes = new Uint8Array(wx.base64ToArrayBuffer(value));
  var result = "";
  for (var offset = 0; offset < bytes.length; offset += 4096) {
    result += String.fromCharCode.apply(null, bytes.subarray(offset, offset + 4096));
  }
  return result;
} : globalThis.atob;
...
module.exports.Live2DCubismCore = Live2DCubismCore;
